...
export default function OverlayPage() {
  ...
  return (
    <div className={`relative w-screen h-screen overflow-hidden bg-[#0a0a1a] ${shakeScreen ? "animate-shake" : ""}`}>
      {/* Screen Flash */}
      {screenFlash && (
        <div className="absolute inset-0 z-[60] pointer-events-none transition-opacity" style={{ background: screenFlash }} />
      )}
      ...
      <button
        ...
        className={`absolute top-3 right-3 z-50 hover:scale-110 text-white w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-2xl md:text-3xl transition-all ${
          soundEnabled && audioReady
            ? "bg-green-600/80 ring-2 ring-green-400/50"
            : "bg-slate-800/80 ring-2 ring-red-500/50"
        }`}
      >
        {soundEnabled ? "🔊" : "🔇"}
      </button>
      ...
      {game.status === "waiting" && (
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-purple-950 via-[#0a0a1a] to-[#0a0a1a]">
          <div className="text-center px-6 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-black neon-text mb-3" style={{ fontFamily: "Orbitron" }}>ANIME WIZ</h1>
          ...
          <div className="flex-1 flex flex-col lg:flex-row gap-3 px-4 md:px-6 pb-3 md:pb-4 overflow-hidden">
              ...
              {game.currentQuestion ? (
                <div className="glass-card neon-border flex-1 flex flex-col p-4 md:p-6 lg:p-8 animate-scale-in overflow-hidden" key={game.currentQuestion.id}>
                  ...
                  <div className="flex items-center justify-between mb-4 md:mb-6">
                    ...
                    <div className={`flex items-center gap-2 px-4 py-2 md:px-5 rounded-full font-black ${
                      ...
                      <span className="text-xl md:text-3xl" style={{ fontFamily: "Orbitron" }}>{game.timeRemaining}</span>
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 lg:gap-4 auto-rows-fr min-h-0">
                    {game.currentQuestion.options.map((opt, i) => {
                      ...
                      return (
                        <div key={i} className={`relative flex items-center gap-3 md:gap-4 p-3 md:p-4 lg:p-5 rounded-xl md:rounded-2xl border-2 transition-all overflow-hidden ${
                          isCorrect ? "border-green-400 bg-green-500/30 shadow-[0_0_30px_rgba(34,197,94,0.3)]" :
                          isWrong ? "border-gray-700 bg-gray-800/50 opacity-50" :
                          ...
                          <div className={`relative z-10 w-10 h-10 md:w-14 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center font-black text-xl md:text-3xl text-white shrink-0 ${
                    ...
                    <div className="mt-3 md:mt-4 animate-slide-in-up">
                      <div className="bg-green-500/15 border-2 border-green-500/40 rounded-xl md:rounded-2xl p-3 md:p-5 text-center">
                        {game.winnerDisplayName ? (
                          <div>
                            <p className="text-xl md:text-3xl font-black text-yellow-300" style={{ fontFamily: "Orbitron" }}>🏆 {game.winnerDisplayName}</p>
                ...
                <div className="glass-card neon-border flex-1 flex items-center justify-center p-8">
                  <div className="text-center">
                    ...
                    <p className="text-3xl md:text-4xl text-purple-300 neon-text-purple font-black" style={{ fontFamily: "Orbitron" }}>GET READY!</p>
            ...
            <div className="hidden lg:flex w-80 xl:w-96 flex-col gap-3">
              <div className="glass-card neon-border-gold p-4 xl:p-5 flex-1 overflow-hidden flex flex-col">
                <h2 className="text-lg xl:text-xl font-black text-yellow-300 mb-4 text-center" style={{ fontFamily: "Orbitron" }}>🏆 LEADERBOARD</h2>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-50">
          <div className="animate-bounce-in text-center mx-6">
            <div className="glass-card neon-border-gold p-8 md:p-12 rounded-3xl max-w-lg">
              ...
              <p className="text-3xl md:text-5xl font-black text-yellow-300 neon-text-gold" style={{ fontFamily: "Orbitron" }}>{game.winnerDisplayName}</p>
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/70 z-50 victory-screen">
          <div className="text-center animate-scale-in max-w-2xl w-full mx-4">
            <div className="glass-card neon-border-gold p-8 md:p-12 rounded-3xl">
              <h1 className="text-3xl md:text-5xl font-black text-yellow-300 neon-text-gold mb-2" style={{ fontFamily: "Orbitron" }}>🏆 ROUND {game.currentRound} 🏆</h1>
      ...
      {game.status === "paused" && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/50 z-40">
          <div className="animate-pulse text-center">
            ...
            <p className="text-4xl md:text-5xl font-black text-yellow-300 neon-text-gold" style={{ fontFamily: "Orbitron" }}>PAUSED</p>
          </div>
        </div>
      )}
